...
export const generateContractPDF = (data: ContractData) => {
  ...
  if (isTransportadora) {
      addText(`4.1 A escada deverá ser entregue no prazo de ${days} dias úteis, contados a partir da data de confirmação do pagamento do sinal.`, 11, false, 'justify');
      ...
      let defaultDeliveryText = `A escada deverá ser entregue no prazo de ${days} dias úteis, contados a partir da data de confirmação do pagamento do sinal.`;
