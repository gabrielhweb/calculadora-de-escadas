    ...
    if (!user) {
        return (
            <div className="max-w-4xl mx-auto p-4 flex flex-col items-center justify-center h-[50vh]">
                ...
                <p className="text-gray-500 dark:text-gray-400">Você precisa estar logado para acessar as configurações de custo.</p>
            </div>
        );
    }

    if (isLoading) {
        return <div className="text-center mt-10 dark:text-white">Carregando...</div>;
    }

    return (
        <div className="max-w-4xl mx-auto p-4 sm:p-6 pb-20">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <form onSubmit={handleSave} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Custo Médio do Aço (Por Degrau)</label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-highlight outline-none text-gray-900 dark:text-white"
                                    step="0.01"
                                    min="0"
                                />
                            </div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Custo Médio da Madeira (Por Degrau)</label>
                            <div className="relative">
                                <span className="absolute left-3 top-2 text-gray-500 dark:text-gray-400">R$</span>
                                <input
                                    type="number"
                    ...
                    <div className="flex justify-end pt-4 border-t border-gray-200 dark:border-gray-700">
                        <button
                            type="submit"
                            disabled={isSaving}
                            className="bg-highlight hover:bg-yellow-600 text-white px-6 py-2 rounded-lg font-bold transition-colors disabled:opacity-50"
                        >
