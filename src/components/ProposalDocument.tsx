...
export const ProposalDocument: React.FC<ProposalDocumentProps> = ({ options, userData, inputData, freightCost, tollCost, installationCost, isTransportadora, deliveryDays = 20, onBack }) => {
  ...
  const createPdfDoc = useCallback(() => {
    ...
    doc.setFont('helvetica', 'normal');
    const deliveryText = `• ${deliveryDays} dias úteis, contados a partir da confirmação do pagamento do sinal.`;
